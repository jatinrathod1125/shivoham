...
@section('content')
    ...
    <x-admin.page-header
        ...
        subtitle="Create hero sliders, category header graphics, and promotional popups."
        :breadcrumbs="[
            ['title' => 'Banners', 'url' => route('admin.banners.index')],
            ['title' => 'Add Banner', 'url' => '']
        ]"
    >
        <x-slot:actions>
            <x-admin.button
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                <x-form.select
                                    ...
                                    :required="true"
                                >
                                    <option value="home_hero" {{ old('position') === 'home_hero' ? 'selected' : '' }}>Home Hero Slider (Top of Homepage)</option>
                                    <option value="promotional_bar" {{ old('position') === 'promotional_bar' ? 'selected' : '' }}>Promotional Strip Bar</option>
                                    <option value="category_top" {{ old('position') === 'category_top' ? 'selected' : '' }}>Category Page Header</option>
                                    <option value="sidebar" {{ old('position') === 'sidebar' ? 'selected' : '' }}>Sidebar Promo Widget</option>
                                    <option value="popup" {{ old('position') === 'popup' ? 'selected' : '' }}>Entrance Popup Modal</option>
                                </x-form.select>
                            </div>
