...
@php
    ...
    $classes = 'w-full rounded-lg text-sm bg-white border transition-colors duration-150 placeholder:text-slate-400 focus:outline-hidden focus:ring-2 disabled:bg-slate-50 disabled:text-slate-500 disabled:cursor-not-allowed p-3.5 ' .
